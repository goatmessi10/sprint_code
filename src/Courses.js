...
const [cardContent,setCardContent] = useState({cardDetails})
  ...
  return(
    ...
    <div  className="course-card-display" >
        ...
        diffClass = {"orange"} difficulityType={cardContent.cardDetails.difficulity.medium} ></CourseCard>
        ...
        diffClass = {""} difficulityType={cardContent.cardDetails.difficulity.beginner} ></CourseCard>
